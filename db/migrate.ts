...
async function migrate() {
  ...
  await gatedQuery(client, `
    ...
    -- This is the normalized home for platform-facing bot/user ids such as a
    -- Discord bot user id. agents.metadata.discord_id remains a compatibility
    -- mirror during rollout, but it is not the long-term authority.
