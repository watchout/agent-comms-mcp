...
async function migrate() {
  ...
  await gatedQuery(client, `
    ...
    -- Shirube V4 D1 production admission and delivery ledger. These tables are
    -- inert until the default-off runtime gate and exact enrollment tuple are
    -- both enabled. They preserve authorization, invocation, and effect
    -- receipts independently so crash/restart replay cannot widen authority or
    -- select another sink.
