...
async function migrate() {
  ...
  await gatedQuery(client, `
    ...
    DO $$ BEGIN
      ...
      ALTER TABLE agents ADD COLUMN IF NOT EXISTS historical_only BOOLEAN NOT NULL DEFAULT false;
      ALTER TABLE agents ADD COLUMN IF NOT EXISTS new_work_allowed BOOLEAN NOT NULL DEFAULT true;
    EXCEPTION WHEN duplicate_column THEN NULL;
    END $$;
    UPDATE agents
    ...
    DO $$ BEGIN
      ALTER TABLE role_routing ADD COLUMN IF NOT EXISTS active_function TEXT;
      ALTER TABLE role_routing ADD COLUMN IF NOT EXISTS canonical_seat TEXT;
      ALTER TABLE role_routing ADD COLUMN IF NOT EXISTS historical_only BOOLEAN NOT NULL DEFAULT false;
    EXCEPTION WHEN duplicate_column THEN NULL;
    END $$;
