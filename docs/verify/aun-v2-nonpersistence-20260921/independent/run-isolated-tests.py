...
out=Path('docs/verify/aun-v2-nonpersistence-20260921/independent');out.mkdir(exist_ok=True)
...
fixture=Path('/tmp/aun-independent-pg-env.json')
if fixture.exists():env.update(json.loads(fixture.read_text()))
if any('test_runtime_observation_nonpersistence_db.test.ts' in a for a in sys.argv[2:]):env['AGENT_COMMS_DESTRUCTIVE_MIGRATIONS_ALLOWED']='1'
