...
out=Path('docs/verify/aun-v2-nonpersistence-20260921/trial-ready-003-contracts');out.mkdir(exist_ok=True)
...
if any(a.endswith(('test_runtime_observation_nonpersistence_db.test.ts','test_runtime_nonpersist_profile.test.ts','test_runtime_nonpersist_configuration_contract.test.ts','aun-configuration-reconciliation.test.ts')) for a in sys.argv[2:]):env['AGENT_COMMS_DESTRUCTIVE_MIGRATIONS_ALLOWED']='1'
