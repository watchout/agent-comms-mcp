...
describe('T10 — queue doctor CLI surface', () => {
  ...
  test('CP-70 doctor pins broad prompt-artifact scan and dry-run exact-id policy', () => {
    expect(CP70_DOCTOR_SRC).toMatch(/TUI_WAKE_PROMPT_PRESENT/)
    ...
    expect(CP70_DOCTOR_SRC).toMatch(/STATE_DAEMON_LAUNCHAGENT_MISMATCH/)
    expect(CP70_DOCTOR_SRC).toMatch(/STATE_DAEMON_CHECKOUT_PATH_SUSPECT/)
